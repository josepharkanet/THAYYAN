...
export default async function ProductDetailPage({
  ...
  return (
    <>
      {/* Breadcrumb */}
      <div className="mx-auto max-w-7xl px-5 pt-28 sm:px-8 sm:pt-36 lg:px-12">
        <nav className="flex items-center gap-1.5 text-[0.72rem] uppercase tracking-[0.14em] text-ink-3">
      ...
      {/* Ready stock — available now (top of page) */}
      {readyBlocks.length > 0 ? (
        <section id="ready-stock" className="scroll-mt-24">
          <div className="mx-auto max-w-7xl px-5 pt-8 sm:px-8 lg:px-12">
            <div className="rounded-lg border border-sage/40 bg-sage-soft/40 p-6 sm:p-8">
                  ...
                  <div key={b.id} className="overflow-hidden rounded-md border border-line bg-paper">
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-4 space-y-2">
                        <AddToEnquiry
                          itemKey={`${product.slug}-${b.id}`}
                          slug={product.slug}
                          name={product.name}
                          imageUrl={b.url}
                          label={b.qty ? `${b.qty} Sqft` : "Available"}
                          variant="block"
                        />
                        <a
                          ...
                          className="inline-flex w-full items-center justify-center gap-2 bg-ink px-4 py-2.5 text-[0.7rem] font-semibold uppercase tracking-[0.12em] text-paper transition-colors hover:bg-sage"
                        >
      ...
      {/* Product hero */}
      <section className="mx-auto max-w-7xl px-5 pb-20 pt-10 sm:px-8 lg:px-12">
